...
const routes: Routes = [
...

  {
    ...
    loadChildren: () =>
      import('./display-featured-artists/display-featured-artists.module').then(
        (m) => m.DisplayFeaturedArtistsPageModule
      ),
  },
  {
    path: 'update-artists',
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./artist-details-component/artist-details-component.module').then(
        (m) => m.ArtistDetailsComponentPageModule
      ),
  },
];
@NgModule({
